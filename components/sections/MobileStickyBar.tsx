...
export function MobileStickyBar() {
  ...
  return (
    <div
      className={`fixed inset-x-0 bottom-0 z-40 border-t border-kva-stone-light/80 bg-background/95 px-3 py-2 backdrop-blur-md transition-transform duration-300 md:hidden ${
    ...
    >
      <div className="mx-auto flex max-w-md items-center gap-2">
        <a
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-full border border-kva-forest bg-kva-cream px-4 py-3 text-sm font-medium text-kva-forest transition-colors hover:bg-kva-forest hover:text-kva-cream focus:outline-none focus-visible:ring-2 focus-visible:ring-kva-forest focus-visible:ring-offset-2"
